...
import STYLES from './PublishedSecretSantaPage.module.scss';
...
const PublishedSecretSantaPage = ({ draw, track, facebookContext }) => {
    ...
    >
      ...
      {result.value ? (
        ...
        <>
          ...
          <div className={c('PublishedSecretSantaPage__participate-with-facebook')}>
...
PublishedSecretSantaPage.propTypes = {
...
export default withTracking(withFacebookSdk(PublishedSecretSantaPage));
